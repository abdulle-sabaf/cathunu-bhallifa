...
\section{直线交角}
\begin{wrapfigure}{r}{0.21\textwidth} %this figure will be at the right
    \vspace{-10pt}
...
\section{相似和比例}
% TODO \includegraphics[width=0.54\textwidth]{相似图像.png}
观察右图，两个图形之间有什么关系？
两个图形可以形状一样，只有大小不同。
这样的关系，称为相似关系。
...
\begin{wrapfigure}{l}{0.12\textwidth} %this figure will be at the right
    \vspace{-10pt}
