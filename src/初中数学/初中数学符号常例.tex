...
\begin{longtable}{ m{15em} m{15em} }
    ...
    $A^c$ & $A$在全集中的补集 \\
    $f:\; \mathbb{Z} \rightarrow \mathbb{R}$ & $f$是从$\mathbb{N}$到$\mathbb{R}$的映射 \\
    ...
    $\triangle ABC$ & 三角形$ABC$ \\
    $\triangle ABC \simeq \triangle A'B'C'$ &  三角形$ABC$同角全等于三角形$A'B'C'$ \\
    $\triangle ABC \backsimeq \triangle A'B'C'$ & 三角形$ABC$反角全等于三角形$A'B'C'$ \\
