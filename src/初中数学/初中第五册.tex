...
\newlength{\colwidth}
\setlength{\colwidth}{\dimexpr(0.7\textwidth-2\tabcolsep*13)/13\relax}
% 定义居中对齐的固定宽度列类型
...
\hline
% 表头行（第一页）
\diagbox[width=\colwidth]{k}{p} & \textbf{2} & \textbf{3} & \textbf{5} & \textbf{7} & \textbf{11} & \textbf{13} & \textbf{17} & \textbf{19} & \textbf{23} & \textbf{29} & \textbf{31} & \textbf{37} \\ \hline
\endfirsthead
\hline
% 续表头（后续页）
...
\hline
% 表头行（第一页）
\diagbox[width=\colwidth]{p}{q} & \textbf{2} & \textbf{3} & \textbf{5} & \textbf{7} & \textbf{11} & \textbf{13} & \textbf{17} & \textbf{19} & \textbf{23} & \textbf{29} & \textbf{31} & \textbf{37} \\ \hline
\endfirsthead
\hline
% 续表头（后续页）
\multicolumn{13}{|c|}{{\bfseries 续表}} \\ \hline
...
\endlastfoot
\textbf{2} & \cellcolor{red!20}假 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 \\ \hline
\textbf{3} & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 \\ \hline
\textbf{5} & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 \\ \hline
\textbf{7} & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 \\ \hline
\textbf{11} & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 \\ \hline
\textbf{13} & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 \\ \hline
\textbf{17} & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 \\ \hline
\textbf{19} & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 \\ \hline
\textbf{23} & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{green!20}真 & \cellcolor{green!20}真 & \cellcolor{green!20}真 \\ \hline
\textbf{29} & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{green!20}真 & \cellcolor{green!20}真 \\ \hline
\textbf{31} & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{green!20}真 \\ \hline
\textbf{37} & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 & \cellcolor{red!20}假 \\ \hline 
$\mathbf{\vdots}$ 
\end{longtable}
...
要么对某个$n$的值“一路全假”。也就是说，“有求必允”的否定是“一路全假”。同理，“有求必拒”的否定是“一路全真”。换句话说，$\exists\forall$类和$\forall\exists$是对立的。
...
\end{align*}
每个命题依据辖词分为两层。外层命题的真假取决于内层命题的真假。我们发现，$\forall\forall$类和$\exists\exists$是对立的，$\exists\forall$类和$\forall\exists$是对立的。具体来说，如果对某个二元判断$P$，命题“$\forall \, p\in X \,\forall \,q\in Y, \,\,\, P(p,q)$”为假，那么“$\exists \, p\in X \,\exists \,q\in Y, \,\,\,\neg P(p,q)$”为假；反之亦然。如果对某个二元判断$P$，命题“$\forall \, p\in X \,\exists \,q\in Y, \,\,\, P(p,q)$”为假，那么“$\exists \, p\in X \,\forall \,q\in Y, \,\,\,\neg P(p,q)$”为假；反之亦然。
...
\begin{so}
    ...
    它的否定按照规则，依次翻转量词：$\forall x$ 变成 $\exists x$，$\exists y$ 变成 $\forall y$，$\exists n$ 变成 $\forall n$，并否定最内层判断：  
    \[
    ...
    它的否定：$\exists x$ 变成 $\forall x$，$\forall y$ 变成 $\exists y$，$\exists n$ 变成 $\forall n$，并否定最内层判断：  
    \[
...
\begin{xt}
    \mbox{} \\
    \indent 1. 写出下列命题的否定形式，并尝试判断它们的真假（可结合具体集合讨论）：
    \begin{enumerate}
        \item $\forall a\in\mathbb{R},\; \exists b\in\mathbb{R},\; a+b=0.$
        \item $\exists n\in\mathbb{N},\; \forall m\in\mathbb{N},\; n\le m.$
        \item $\forall x\in\mathbb{Q},\; \exists y\in\mathbb{Q},\; (x<y).$
        \item $\exists x\in\mathbb{Z},\; \forall y\in\mathbb{Z},\; (x>y).$
    \end{enumerate}
    \indent 2. 将下列日常语句符号化为多层命题，并写出它们的否定形式：
    \begin{enumerate}
        \item 每个学生都有一本最喜欢的书。
        \item 有一本书被所有男生喜欢，但不被任何女生喜欢。
