...
\begin{sk}\label{sk:4-1-0}
    \mbox{} \\
    \indent 1. 证明：角的轴对称图形是大小相反的角。\\
    \indent 2. 直角坐标系中，两点关于点$(4,3)$对称。这两点的坐标有什么关系？\\
    \indent 3. 三角形关于一点的对称图形，与它自己有什么关系？\\
    \indent 4. 证明：角的中心对称图形是大小相等的角。\\
    \indent 5. 三角形关于直线的对称图形与它自己有什么关系？
\end{sk}
