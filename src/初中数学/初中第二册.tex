...
\begin{wrapfigure}{r}{0.3\textwidth} %this figure will be at the right
    \vspace{-15pt}
    \flushright
    \includegraphics[width=0.24\textwidth]{角度1.png}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.3\textwidth} %this figure will be at the right
    \vspace{-5pt}     
    \flushright
    \includegraphics[width=0.24\textwidth]{角度2.png}
\end{wrapfigure}
...
\begin{wrapfigure}{l}{0.4\textwidth} %this figure will be at the left
    \vspace{-5pt}     
    \flushleft
    \includegraphics[width=0.36\textwidth]{角度3.png}
    \caption*{\texttt{量角器\;\;\;\;\;}}
\end{wrapfigure}
...
\begin{wrapfigure}{r}{0.4\textwidth} %this figure will be at the right
    \flushright
    \includegraphics[width=0.36\textwidth]{三线八角.png}
\end{wrapfigure}
...
\begin{wrapfigure}[6]{r}{0.24\textwidth} %this figure will be at the right
    \vspace{50pt}
    \flushright
    \includegraphics[width=0.2\textwidth]{675px-Diyarbakir_1050645_Droste_Effect.jpg}
\end{wrapfigure}
