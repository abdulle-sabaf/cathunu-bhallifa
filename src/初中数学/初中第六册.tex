...
\begin{wrapfigure}[9]{r}{0.38\textwidth} %this figure will be at the right
    \vspace{-20pt}
    \flushright
    \includegraphics[width=0.36\textwidth]{投影变换例2.png}
...
\begin{figure}[H]
    \vspace{4pt}
    \centering
    \includegraphics[width=0.8\textwidth]{投影和反射1.png}
...
\begin{figure}[h] %this figure will be at the right
    ...
    \includegraphics[width=0.6\textwidth]{条件概率1.png}
...
\begin{figure}[h] %this figure will be at the right
    ...
    \centering
    \captionsetup{justification=centering}
    \includegraphics[width=0.6\textwidth]{条件概率2.png}
