...
表达肯定态度的简单判断（命题），称为\textbf{肯定判断}（\textbf{命题}）；表达否定态度的简单判断（命题），称为\textbf{否定判断}（\textbf{命题}）。
...
联言命题一般使用“既……又……”，“不仅……而且……”这样表示并列关系的连词，把各个判断连起来。
每个判断称为它的\textbf{分支判断}。
...
或言命题一般使用“也许……也许……”，“……或者……”这样表示并列关系的连词，把各个判断连起来。
每个判断称为它的分支判断。
...
选言命题一般使用“要么……要么……”，“或者……或者……”这样表示并列关系的连词，把各个判断连起来。
...
我们一般使用“如果……那么……”，“只要……就……”等连词表达充分条件假言判断。
