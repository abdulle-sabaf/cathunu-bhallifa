...
\begin{figure}[H] 
    \vspace{4pt}
    \centering
    \includegraphics[width=0.5\textwidth]{圆面积2.png}
\end{figure}
...
\begin{figure}[H] 
    \vspace{4pt}
    \centering
    \includegraphics[width=0.8\textwidth]{圆面积3.png}
\end{figure}
...
\begin{figure}[H] 
    \vspace{4pt}
    \centering
    \includegraphics[width=0.5\textwidth]{圆面积1.png}
\end{figure}
...
\begin{figure}[h] %this figure will be at the right
    \vspace{4pt}
    \centering
    \includegraphics[width=0.5\textwidth]{圆内接多边形1.png}
\end{figure}
