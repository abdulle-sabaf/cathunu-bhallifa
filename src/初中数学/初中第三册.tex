...
\begin{et}
    计算：\\
    \indent 1. $\sqrt{15}\cdot\sqrt{60}$ \\
    \indent 2. $\sqrt[3]{9}\cdot\sqrt[3]{24}$ \\
    \indent 3. $\sqrt[3]{12}\cdot\sqrt{3}$ \\
    \indent 4. $\sqrt[4]{324}\cdot\sqrt{2}$ \\
\end{et}
...
\begin{sk}
    ...
    \indent 2. 方根的加减有没有规律？两个$k$次方根的和的$k$次方，有什么特征？
\end{sk}
