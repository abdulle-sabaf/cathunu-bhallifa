...
因此，以上的距离小于$\sqrt{2 \cdot \frac{r^2}{4}} = \frac{\sqrt{2}r}{2} < r$。这说明$c$在$t_0$连续。

如果$t_0 = 0$，由于$c(0) = c(2\pi)$，它附近一点$(\cos{t}, \,\, \sin{t})$要么是$t$接近$0$，要么是$t$接近$2\pi$。
对于接近$0$的$t$，如前讨论；对于接近$2\pi$的$t$，$t$趋于$2\pi$时，$t - 2\pi$趋于$0$，而且：
$$(\cos{t}, \,\, \sin{t}) = (\cos{t - 2\pi}, \,\, \sin{t - 2\pi}),$$
因此，由于正弦函数和余弦函数在$0$处连续，可以得出$t$趋于$2\pi$时，$(\cos{t}, \,\, \sin{t})$也趋于$(\cos{0}, \,\, \sin{0})$。
这说明$c$在$0$处连续。
