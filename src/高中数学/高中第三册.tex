...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{微变零值定理1.png}    
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{微变中值定理1.png}    
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{凹凸函数1.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{凸函数变率1.png}
\end{figure}
...
\begin{df}{\textbf{集合上的序}}
    ...
    \begin{enumerate}
        \item 自反性：$\forall x, \,\,\, x \triangleleft x$。
...
\begin{proof}
    ...
    自反性：集合总有到自己的单射（恒等映射），因此$|A| \leqslant |A|$总成立。
